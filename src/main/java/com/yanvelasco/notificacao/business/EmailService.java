package com.yanvelasco.notificacao.business;

import com.yanvelasco.notificacao.business.dto.TarefaDTO;
import com.yanvelasco.notificacao.business.exceptions.EmailException;
...
public class EmailService {
    ...
    public void enviaEmail(TarefaDTO tarefaDTO) {
        try{
            ...
            mimeMessageHelper.setTo(InternetAddress.parse(tarefaDTO.getEmailDoUsuario()));
            mimeMessageHelper.setSubject("Notificação de tarefa");

            Context context = new Context();
            context.setVariable("nomeTarefa", tarefaDTO.getNomeDaTarefa());
            context.setVariable("dataEvento", tarefaDTO.getDataEvento());
            context.setVariable("descricao", tarefaDTO.getDescricao());
            String html = templateEngine.process("notificacao.html", context);
